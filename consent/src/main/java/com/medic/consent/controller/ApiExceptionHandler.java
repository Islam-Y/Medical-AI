...
import com.medic.consent.dto.ApiError;
...
public class ApiExceptionHandler {
    ...
    ResponseEntity<ApiError> notFound(ConsentNotFoundException exception) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ApiError("consent_not_found", exception.getMessage()));
    }

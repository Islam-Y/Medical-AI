...
import com.medic.indexing.dto.ApiError;
...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(IndexEntryNotFoundException.class)
    ResponseEntity<ApiError> notFound(IndexEntryNotFoundException exception) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ApiError("index_entry_not_found", exception.getMessage()));
    }
